...
const CATEGORY_ICONS: Record<AchievementDef['category'], string> = {
  diagnost: 'search',
  marathon: 'trophy',
  ...
  return (
    <div className="achievements-panel">
      <div className="achievements-header">
        <h3><AnimatedIcon name="trophy" size={20} color="var(--primary)" /> Достижения</h3>
      ...
      {Object.entries(byCategory).map(([cat, list]) => (
        <div key={cat} className="achievements-category">
          <h4 className="achievements-category-title">
            <AnimatedIcon name={CATEGORY_ICONS[cat as AchievementDef['category']] as any} size={14} style={{ marginRight: '6px' }} />
            {CATEGORY_NAMES[cat as AchievementDef['category']]}
          </h4>
